 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const T=new class{handleAttributeExpressions(t,e,s,a){const r=e[0];if("."===r){return new x(t,e.slice(1),s).parts}if("@"===r)return [new N(t,e.slice(1),a.eventContext)];if("?"===r)return [new S(t,e.slice(1),s)];return new v(t,e,s).parts}handleTextExpression(t){return new w(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`,J={accessibilityLabel:null,animationDone:!1,animationDuration:500,animationName:"default",buttonCallback:null,buttonText:null,customClasses:null,duration:4e3,hideCallback:null,message:"Ackbar snackbar: It's a snackbar!",showCallback:null,size:"normal",type:"auto",variant:"default"},W=["default","slide-in","zoom"],X=["small","normal","large"],Y=["auto","dismiss"],Z=["default","success","error","warning","info"],G={accessibilityLabel:t=>!t||"string"==typeof t,animationDuration:t=>!t||"number"==typeof t,animationName:t=>!t||"string"==typeof t&&W.includes(t),buttonCallback:t=>!t||"function"==typeof t,buttonText:t=>!t||"string"==typeof t,customClasses:t=>!t||"string"==typeof t,duration:t=>!t||"number"==typeof t&&!Number.isNaN(t),hideCallback:t=>!t||"function"==typeof t,message:t=>!t||"string"==typeof t&&t.length>0,showCallback:t=>!t||"function"==typeof t,size:t=>!t||"string"==typeof t&&X.includes(t),type:t=>!t||"string"==typeof t&&Y.includes(t),variant:t=>!t||"string"==typeof t&&Z.includes(t)};const K=B`
  :host {
    display: flex;
    align-items: center;
...
`,Q={default:{showAnimation:[{opacity:"0"},{opacity:"1"}],hideAnimation:[{opacity:"1"},{opacity:"0"}]},"slide-in":{showAnimation:[{transform:"translateX(-100%)",opacity:"0"},{transform:"translateX(0)",opacity:"1"}],hideAnimation:[{transform:"translateX(0)",opacity:"1"},{transform:"translateX(-100%)",opacity:"0"}]},zoom:{showAnimation:[{transform:"scale(0)",opacity:"0"},{transform:"scale(1)",opacity:"1"}],hideAnimation:[{transform:"scale(1)",opacity:"1"},{transform:"scale(0)",opacity:"0"}]}};window.customElements.define("ackbar-bar",class extends F{render(){return $`
    ...
    `}static get styles(){return B`
      ${K}
    `}static get properties(){return {animationDone:{type:Boolean},animationDuration:{type:Number},animationName:{type:String},buttonCallback:{type:Function},buttonText:{type:String},duration:{type:Number},id:{type:String},message:{type:String},type:{type:String}}}set buttonText(t){t&&this.setAttribute("hasButton",""),this._buttonText=t;}get buttonText(){return this._buttonText}constructor(){super(),this._timer=this._timer.bind(this),this._showStart=Date.now();}connectedCallback(){super.connectedCallback(),"auto"!==this.type&&this._buttonText||this._timer(),this.setAttribute("aria-label",this.accessibilityLabel||`Snackbar: ${this.message}`),this.setAttribute("role","alert");}_timer(){Date.now()-this._showStart>=this.duration?(this._fadeOut(),cancelAnimationFrame(this._timer)):requestAnimationFrame(this._timer);}update(t){super.update(t),this.animationDone||this._fadeIn();}_fadeIn(){const t=Q[this.animationName].showAnimation,e={duration:this.animationDuration,iterations:1};this.animate(t,e).onfinish=()=>{"function"==typeof this.showCallback&&this.showCallback();},this.dispatchEvent(new CustomEvent("ackbar-bar-has-faded-in",{bubbles:!0,composed:!0,detail:{snackbarID:this.id}}));}_fadeOut(){const t=Q[this.animationName].hideAnimation,e={duration:this.animationDuration,iterations:1};this.animate(t,e).onfinish=()=>{"function"==typeof this.hideCallback&&this.hideCallback(),this._removeSnackbar();};}_removeSnackbar(){this.dispatchEvent(new CustomEvent("ackbar-snackbar-remove",{bubbles:!0,composed:!0,detail:{snackbarID:this.id}}));}_handleButtonClick(){this._fadeOut(),"function"==typeof this.buttonCallback&&this.buttonCallback();}});customElements.define("ackbar-snackbar",class extends F{render(){return $``}static get styles(){return B`
      ${j}
    `}constructor(){super(),this.newSnackbarProperties=["accessibilityLabel","animationDuration","animationName","buttonCallback","buttonText","duration","hideCallback","message","showCallback","type","hasFadedIn"],this.newSnackbarAttributes=["id","size","variant"],window.addEventListener("ackbar-snackbar-add",this._handleSnackbarAdd.bind(this)),window.addEventListener("ackbar-snackbar-remove",this._handleSnackbarRemove.bind(this));}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("ackbar-snackbar-ready",{bubbles:!0,composed:!0})),this.setAttribute("aria-live","polite");}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ackbar-snackbar-add",this._handleSnackbarAdd.bind(this)),window.removeEventListener("ackbar-snackbar-remove",this._handleSnackbarRemove.bind(this));}_handleSnackbarAdd(t){const e=t.detail||{},s=(a=e,Object.keys(G).filter((t=>!G[t](a[t]))).map((t=>new Error(`${t} is invalid.`))));var a;if(s.length>0)for(const{message:t}of s)console.error("There was a problem creating your snackbar. Please check your custom event options.",t);else {const t={id:Date.now(),...J,...e},s=this._createNewSnackbar(t);this.shadowRoot.prepend(s),this.dispatchEvent(new CustomEvent("ackbar-snackbar-bar-added",{bubbles:!0,composed:!0,detail:{snackbarID:s.id}}));}}_handleSnackbarRemove(t){this.shadowRoot.getElementById(t.detail.snackbarID).remove(),this.dispatchEvent(new CustomEvent("ackbar-snackbar-bar-removed",{bubbles:!0,composed:!0,detail:{snackbarID:t.detail.snackbarID}}));}_createNewSnackbar(t){const e=document.createElement("ackbar-bar");return this.newSnackbarProperties.forEach((s=>{e[s]=t[s];})),this.newSnackbarAttributes.forEach((s=>{e.setAttribute(s,t[s]);})),t.customClasses&&(e.className+=t.customClasses),e}});
